...
public class AppConstants {
    public static final String EMPLOYEE_URI = "/produit";
	public static final String EMPLOYEE_JSON_PARAM = "empJson";
	public static final String EMPLOYEE_FILE_PARAM = "file";
        	public static final String EMPLOYEE_FILE_PARAM_ONE = "fileone";
	public static final String EMPLOYEE_FILE_PARAM_TWO = "filetwo";
